...
class bot(object):
    ...
    def minimax(self,state,depth,player,whenToStop, opponent1_score_before, opponent2_score_before, startTime,alfa,beta):
        if player == 1:
        ...
        for move in self.getFreeLines(state):
            ...
            # print("----------------------")
            # print(depth)
            score = self.minimax(state, depth - 1, nextturn, whenToStop, opponent1_score, opponent2_score, startTime,alfa,beta )
